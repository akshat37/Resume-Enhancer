A SaaS application that helps users tailor their resume to specific job descriptions using AI. Upload your resume, paste a job description, and instantly get a skill-gap analysis with AI-generated improvements, then download a polished resume in your choice of professional template.
...
🚀 Languages: TypeScript 5.9, JavaScript (Node.js 24), SQL (PostgreSQL), HTML / CSS
🚀 Frontend: React 19, Vite 7, TailwindCSS 4, Wouter (routing)
🚀 Backend: Node.js 24, REST API (OpenAPI 3.1 spec-first)
🚀 Database: PostgreSQL
🚀 AI / ML: OpenAI GPT-5.1 (analysis & content generation), GPT-4o Vision (PDF text extraction), Replit AI Integrations (gateway layer)
